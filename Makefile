...
UK:
	$(MDSL) -t UK -c https://www.signin.service.gov.uk/SAML2/metadata/connector > prod/UK.xml
	$(MDSL) -t UK -c https://www.integration.signin.service.gov.uk/SAML2/metadata/connector > test/UK.xml
