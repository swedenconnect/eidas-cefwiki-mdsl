...
FI:
	# Finland
	$(MDSL) -t FI -p https://nodefi1.eidas.tunnistus.fi/EidasNodeProxy/ServiceMetadata -c https://nodefi1.eidas.tunnistus.fi/EidasNode/ConnectorMetadata > prod/FI.xml
...
FR:
	...
	$(MDSL) -t FR -p https://eidas.franceconnect.gouv.fr/EidasNode/ServiceMetadata   -c https://eidas.franceconnect.gouv.fr/EidasNode/ConnectorMetadata > prod/FR.xml
	$(MDSL) -t FR -p https://eidas-fr.integ01.dev-franceconnect.fr/EidasNode/ServiceMetadata -c https://eidas.pp.dev-franceconnect.fr/EidasNode/ConnectorMetadata > test/FR.xml
...
HU:
	# Hungary
	#$(MDSL) -t HU -p https://eidas.gov.hu/proxy/realms/ProxyRealm/protocol/saml/descriptor -c https://eidas.gov.hu/connector/realms/ConnectorRealm/broker/router-saml/endpoint/descriptor > prod/HU.xml
	$(MDSL) -t HU -c https://eidas.gov.hu/connector/realms/ConnectorRealm/broker/router-saml/endpoint/descriptor > prod/HU.xml
...
PL:
	# Poland / Polen
	$(MDSL) -t PL -p https://node.eidas.gov.pl/NodeProxy/Metadata -c https://node.eidas.gov.pl/NodeConnector/Metadata > prod/PL.xml
	$(MDSL) -t PL -p https://node.test.eidas.gov.pl/NodeProxy/Metadata -c https://node.test.eidas.gov.pl/NodeConnector/Metadata > test/PL.xml
